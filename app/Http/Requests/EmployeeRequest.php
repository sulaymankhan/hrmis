...
class EmployeeRequest extends FormRequest
{
    ...
    public function messages(){
        return [
            ...
            'position_code.required'=>'کود نمبر مقام ضروری میباشد',
            'position_type.required'=>'نوعیت مقام ضروری میباشد',
            'post_title.required'=>'عنوان بست ضروری میباشد',
            'project_name.required'=>'عنوان بست ضروری میباشد' 
        ];
    }
}
