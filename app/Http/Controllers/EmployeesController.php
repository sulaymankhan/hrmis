...
class EmployeesController extends Controller
{
    ...
    public function store(EmployeeRequest $r){
       ...
       $employee->position_code = $r->input('position_code');
       $employee->position_type = $r->input('position_type');
       $employee->post_title = $r->input('post_title');
       $employee->project_name = $r->input('project_name');
